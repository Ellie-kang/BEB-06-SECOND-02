...
const Articles = () => {
  ...
  return (
    <Card sx={{ maxWidth: 600 }}>
      ...
      <CardContent>
        <Typography sx={{ maxHeight: '200px', overflow: 'hidden', textOverflow: 'ellipsis', whitespace: 'nowrap' }} variant='body2' color='text.secondary' description=''>
        ...
        <Comments className='card-comments' />
      </CardContent>
    </Card>
  );
};
